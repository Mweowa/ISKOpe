...
{
    public class DocumentsPanelModel : PageModel
    {
        public class Item
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    {
                        cmd.Parameters.AddWithValue("@Category", "documents");
            ...
            {
                System.Console.WriteLine($"Error fetching document items: {ex.Message}");
            }
        }
    }
}
