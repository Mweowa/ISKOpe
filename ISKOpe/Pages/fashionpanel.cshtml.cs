...
{
    public class FashionAccessoriesModel : PageModel
    {
        public class Item
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            ORDER BY Id DESC";
                ...
                {
                    // Change this line to match what's actually stored in your database for "Fashion Accessories"
                    cmd.Parameters.AddWithValue("@Category", "fashion"); // <-- Change this from "fashion accessories"
